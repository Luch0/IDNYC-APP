...
class EnrollmentCenterTableViewCell: UITableViewCell {
    ...
    public func configureCell(center: IDNYCCenter) {
        ...
        if LanguageUserDefaultsHelper.manager.getSelectedLanguage() == "Español" {
            var formatedHours = hours.replacingOccurrences(of: "<br>", with: "\n").replacingOccurrences(of: "<b>", with: "\n").replacingOccurrences(of: "Mon, Tue, Wed, Thu, Fri", with: "Lun - Vie").replacingOccurrences(of: "Mon-Fri", with: "Lun - Vie").replacingOccurrences(of: "Monday - Friday", with: "Lun - Vie").replacingOccurrences(of: "Tue-Sat", with: "Mar - Sab").replacingOccurrences(of: "Sat", with: "Sab").replacingOccurrences(of: "Mon - Thu", with: "Lun - Jue").replacingOccurrences(of: "Mondays - Fridays", with: "Lun - Vie").replacingOccurrences(of: "Mon, Wed, Thu, Fri", with: "Lun, Mie, Jue, Vie").replacingOccurrences(of: "Tue", with: "Mar").replacingOccurrences(of: "Mon - Fri", with: "Lun - Vie").replacingOccurrences(of: "Mon-Thu", with: "Lun - Jue").replacingOccurrences(of: "Mon", with: "Lun").replacingOccurrences(of: "Tue", with: "Tue").replacingOccurrences(of: "Wed", with: "Mie").replacingOccurrences(of: "Thu", with: "Jue").replacingOccurrences(of: "Fri", with: "Vie").replacingOccurrences(of: "Sat", with: "Sab").replacingOccurrences(of: "Sun", with: "Dom")
